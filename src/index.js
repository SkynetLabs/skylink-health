        ...
        fetch(url)
            ...
            .then((res) => {
                ...
                if (res.disabled) {
                    ...
                    abbr.innerHTML = "Disabled";
                    abbr.title = res.disabled;
                    activeCell.innerHTML = "";
                    activeCell.appendChild(abbr);
        ...
        fetch(url)
            ...
            .then((res) => {
                ...
                if (res.streambufferread15mdatapoints) {
                    ...
                    streamBufferRateCell.innerHTML = res.streambufferread15mdatapoints.toLocaleString(
                ...
                if (res.basesectorupload15mdatapoints) {
                    ...
                    baseSectorRateCell.innerHTML = res.basesectorupload15mdatapoints.toLocaleString(
                        undefined, { maximumFractionDigits: 2 }
                    );
                ...
                if (res.chunkupload15mdatapoints) {
                    ...
                    chunkUploadRateCell.innerHTML = res.chunkupload15mdatapoints.toLocaleString(
                        undefined, { maximumFractionDigits: 2 }
                    );
                ...
                if (res.registryread15mdatapoints) {
                    ...
                    regReadRateCell.innerHTML = res.registryread15mdatapoints.toLocaleString(
                        undefined, { maximumFractionDigits: 2 }
                    );
                ...
                if (res.registrywrite15mdatapoints) {
                    ...
                    regWriteRateCell.innerHTML = res.registrywrite15mdatapoints.toLocaleString(
                        undefined, { maximumFractionDigits: 2 }
                    );
