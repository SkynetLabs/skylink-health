(async () => {
  ...
  try {
    const response = await fetch("https://server-list.hns.siasky.net");
    servers = await response.json();

    servers.forEach((server) => {
      if (
        !serverNames.find(
          (name) => server.name === name || server.name.startsWith(`${name}.`)
        )
      ) {
        console.log(`NOT LISTED SERVER: ${server.name} (${server.ip})`);
      }
    });
  } catch {
    // nothing to do
  ...
  for (let i = 0; i < serverNames.length; i++) {
    ...
    fetch(url)
      .then((res) => {
        ...
        var ipCell = row.cells[1];

        if (servers) {
          const server = servers.find(
            ({ name }) =>
              name === serverNames[i] || name.startsWith(serverNames[i] + ".")
          );
          if (server) {
            ipCell.innerHTML = server.ip;
          } else {
            ipCell.innerHTML = "not announced";
            ipCell.style.color = "red";
          }
        }
        ...
        totalCell.innerHTML =
          percentUp.toLocaleString(undefined, { maximumFractionDigits: 0 }) +
          "%";
        if (percentUp >= 75) {
      ...
      .then((res) => {
        ...
        // Update Total Row
        let percentUp =
          ((totalServers - totalAccountDown) / totalServers) * 100;
      ...
      .catch((err) => {
        ...
        if (!ignoreTotals) {
          ...
          totalAccountDown += 1;
          let percentAccountUp =
            ((totalServers - totalAccountDown) / totalServers) * 100;
          let totalAccountUpCell = totalRow.cells[4];
          totalAccountUpCell.innerHTML =
            percentAccountUp.toLocaleString(undefined, {
      ...
      .then((res) => {
        ...
        if (res.versioninfo !== undefined) {
          if (res.versioninfo.gitrevision !== undefined) {
            ...
            versionCell.innerHTML = res.versioninfo.gitrevision.replace(
              /[^\w]/g,
              ""
            );
          }
        ...
        if (res.streambufferread15mdatapoints) {
          ...
          streamBufferRateCell.innerHTML =
            res.streambufferread15mdatapoints.toLocaleString(undefined, {
          ...
          if (!ignoreTotals) {
            ...
            totalCell.innerHTML = totalDLRate.toLocaleString(undefined, {
              maximumFractionDigits: 0,
            });
          }
        }
        ...
        if (res.basesectorupload15mdatapoints) {
          ...
          if (!ignoreTotals) {
            ...
            totalCell.innerHTML = totalULBaseRate.toLocaleString(undefined, {
              maximumFractionDigits: 0,
            });
          }
        }
        ...
        if (res.chunkupload15mdatapoints) {
          ...
          chunkUploadRateCell.innerHTML =
            res.chunkupload15mdatapoints.toLocaleString(undefined, {
              maximumFractionDigits: 2,
            });
          ...
          if (!ignoreTotals) {
            ...
            totalCell.innerHTML = totalULChunkRate.toLocaleString(undefined, {
              maximumFractionDigits: 0,
            });
          }
        }
        ...
        if (res.registryread15mdatapoints) {
          ...
          regReadRateCell.innerHTML =
            res.registryread15mdatapoints.toLocaleString(undefined, {
              maximumFractionDigits: 2,
            });
          ...
          if (!ignoreTotals) {
            ...
            totalCell.innerHTML = totalRRRate.toLocaleString(undefined, {
              maximumFractionDigits: 0,
            });
          }
        }
        ...
        if (res.registrywrite15mdatapoints) {
          ...
          if (!ignoreTotals) {
            ...
            totalCell.innerHTML = totalRWRate.toLocaleString(undefined, {
              maximumFractionDigits: 0,
            });
          }
        }
        ...
        if (res.streambufferread15mp99ms) {
          ...
          downloadCell.innerHTML = p99 + " / " + p999;
        }
        ...
        if (res.registryread15mp99ms) {
          ...
          regReadCell.innerHTML = p99 + " / " + p999;
        }
        ...
        if (res.numfiles !== undefined) {
          ...
          filesCell.innerHTML = res.numfiles.toLocaleString(undefined, {
            maximumFractionDigits: 0,
          });
          ...
          if (!ignoreTotals) {
            ...
            totalCell.innerHTML = totalFiles.toLocaleString(undefined, {
              maximumFractionDigits: 0,
            });
          }
        }
        ...
        if (res.storage !== undefined) {
          ...
          storageCell.innerHTML = storageTBs.toLocaleString(undefined, {
            maximumFractionDigits: 2,
          });
          ...
          if (!ignoreTotals) {
            ...
            totalCell.innerHTML = totalStorage.toLocaleString(undefined, {
              maximumFractionDigits: 0,
            });
          }
        }
        ...
        if (res.contractstorage !== undefined) {
          ...
          var contractData = contractTB.toLocaleString(undefined, {
            maximumFractionDigits: 2,
          });
          ...
          if (!ignoreTotals) {
            ...
            totalCell.innerHTML = totalContractData.toLocaleString(undefined, {
              maximumFractionDigits: 0,
            });
          }
        }
        ...
        if (res.repair !== undefined) {
          ...
          var repairData = repairTB.toLocaleString(undefined, {
            maximumFractionDigits: 2,
          });
          ...
          if (!ignoreTotals) {
            ...
            totalCell.innerHTML = totalRepairData.toLocaleString(undefined, {
              maximumFractionDigits: 0,
            });
          }
        }
